    ...
    <div className="bg-slate-50 min-h-full pb-28 animate-in fade-in duration-300">
      ...
      {!isOwnProfile && (
        <div className="p-4 pt-6">
           <button 
             onClick={onRegresar} 
             className="w-10 h-10 flex items-center justify-center rounded-full bg-white border border-slate-100 shadow-sm text-slate-400 hover:text-blue-600 active:scale-95 transition-all"
           >
              <ArrowLeft size={18} />
           </button>
        </div>
      ...
      <div className="px-4">
        <div className="bg-white p-6 rounded-[35px] border border-slate-100 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center pb-6">
            ...
            {/* NOMBRE REAL: Solo muestra el nombre tal cual está en Firebase */}
